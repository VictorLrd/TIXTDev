...
var ProductListComponent = React.createFactory(require('../components/ProductListComponent'));
...
var context = JSON.parse(decodeHTML(document.getElementById('context').textContent));

var mountNode = document.getElementById("product-parent");

ReactDOM.render(ProductListComponent({ 'products': context.products }), mountNode);

},{"../components/ProductListComponent":4,"react":165,"react-dom":36}],2:[function(require,module,exports){
"use strict";
...
var Header = function (_React$Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      return React.createElement("div", { className: "header" }, React.createElement("div", { className: "menu" }, React.createElement("h1", { className: "inscription" }, "M'inscrire"), React.createElement("h1", { className: "connexion" }, "Me connecter"), React.createElement("h1", { className: "infos" }, "Plus d'infos ?"), React.createElement("h1", { className: "louer" }, "Louer ma voiture")));
    }
  }]);
...
var Login = function (_React$Component) {
    ...
    function Login() {
        ...
        _this.writeUser = _this.writeUser.bind(_this);
    ...
    _createClass(Login, [{
        ...
        key: 'writeUser',
        value: function writeUser() {

            return fetch('/barbero').then(function (response) {
        ...
        value: function render() {
            ...
            return React.createElement('div', { className: 'form-group' }, React.createElement('div', { className: 'input-group col-md-6' }, React.createElement('input', { type: 'text',
                ...
                ref: function ref(_ref) {
                    return _this2.emailInput = _ref;
                },
                placeholder: 'Email' }), React.createElement('input', { type: 'text',
                className: 'form-control',
                ref: function ref(_ref2) {
                    return _this2.mdpInput = _ref2;
                },
                placeholder: 'Mot de passe' }), React.createElement('span', { className: 'input-group-btn' }, React.createElement('button', { onClick: this.writeUser, className: 'btn btn-primary', type: 'button' }, React.createElement('span', { className: 'glyphicon glyphicon-search' })))));
        }
    }]);
...
var ProductListComponent = function (_React$Component) {
	...
	_createClass(ProductListComponent, [{
		key: 'handleSearch',
		value: function handleSearch(productName) {
			var _this2 = this;

			var url = '/products?productName=' + productName;
		...
		key: 'render',
		value: function render() {
			return React.createElement('div', null, React.createElement(Header, { header: this.header }), React.createElement(Login, { login: this.login }), React.createElement(Slider, { Slider: this.index }));
		}
	}]);
...
},{"./Header":2,"./Login":3,"./ProductTable":5,"./SearchBar":6,"./Slider":7,"react":165}],5:[function(require,module,exports){
"use strict";
	...
	_createClass(ProductTable, [{
		...
		value: function render() {
			...
			this.props.products.forEach(function (p) {
				return rows.push(React.createElement(ProductItem, { key: p.id, product: p }));
			});
		...
		value: function createProductTable(rows) {
			return React.createElement("table", { className: "table table-hover" }, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", null, "Nom"), React.createElement("th", null, "Quantit\xE9"), React.createElement("th", null, "Lieu de frabrication"))), React.createElement("tbody", null, rows));
		}
	}, {
		key: "createProductNotFoundAlert",
		value: function createProductNotFoundAlert() {
			return React.createElement("div", { className: "alert alert-info" }, React.createElement("strong", null, "Aucun produit trouv\xE9 !"));
		}
	}]);
...
var ProductItem = function (_React$Component2) {
	...
	_createClass(ProductItem, [{
		key: "render",
		value: function render() {
			return React.createElement("tr", null, React.createElement("td", null, this.props.product.name), React.createElement("td", null, this.props.product.quantity), React.createElement("td", null, React.createElement("img", { src: "img/blank.gif", className: "flag flag-" + this.props.product.from.suffix,
...
var SearchBar = function (_React$Component) {
	...
	_createClass(SearchBar, [{
		...
		value: function searchProduct() {
			var productName = this.textInput.value;
		...
		value: function render() {
			...
			return React.createElement('div', { className: 'form-group' }, React.createElement('div', { className: 'input-group col-md-6' }, React.createElement('input', { type: 'text',
				...
				placeholder: 'Recherche....' }), React.createElement('span', { className: 'input-group-btn' }, React.createElement('button', { onClick: this.searchProduct, className: 'btn btn-primary', type: 'button' }, React.createElement('span', { className: 'glyphicon glyphicon-search' })))));
		}
	}]);
...
},{"react":165,"react-dom":36}],7:[function(require,module,exports){
"use strict";
...
var Slider = function (_React$Component) {
  ...
  _createClass(Slider, [{
    key: "render",
    value: function render() {
      return React.createElement("div", { className: "slider" }, React.createElement("h1", null, "Louer une voiture n'as jamais \xE9t\xE9 aussi facile !"), React.createElement("input", { className: "recherche", type: "text", placeholder: "Search.." }));
    }
  }]);
